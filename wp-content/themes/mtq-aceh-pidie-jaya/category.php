...
<main id="primary" class="site-main">
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
		...
		<?php if (have_posts()) : ?>
			...
			<!-- Category Header -->
			<header class="category-header mb-12">
				<div class="relative bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 rounded-2xl overflow-hidden">
					<!-- Background Pattern -->
					<div class="absolute inset-0 bg-black/20"></div>
					<div class="absolute inset-0" style="background-image: url('data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23ffffff" fill-opacity="0.05"%3E%3Ccircle cx="30" cy="30" r="1.5"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E');"></div>
					...
					<div class="relative px-8 py-16 md:py-20 text-center">
						...
						if ($description) : ?>
							<div class="text-lg md:text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
								<?php echo $description; ?>
							</div>
						<?php endif; ?>
						
						<div class="mt-6 flex flex-wrap items-center justify-center gap-4 text-blue-200">
							...
							<div class="p-6">
								...
								<div class="flex items-center justify-between pt-4 border-t border-gray-100">
									...
									<a href="<?php the_permalink(); ?>" 
									   class="inline-flex items-center gap-1 text-blue-600 hover:text-blue-700 font-medium text-sm transition-colors group">
										Baca Selengkapnya
						...
						<div class="flex flex-wrap justify-center gap-2">
							...
							foreach ($pages as $page) :
								...
								if (strpos($page, 'current') !== false) {
									$page = str_replace('page-numbers current', 'inline-flex items-center justify-center px-4 py-2 text-sm font-medium bg-blue-600 text-white border border-blue-600 rounded-lg hover:bg-blue-700 transition-colors min-w-[44px] h-11', $page);
								} elseif (strpos($page, 'dots') !== false) {
									$page = str_replace('page-numbers dots', 'inline-flex items-center justify-center px-2 py-2 text-gray-400', $page);
								} else {
									$page = str_replace('page-numbers', 'inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 hover:text-blue-600 transition-colors min-w-[44px] h-11 no-underline', $page);
								}
								echo $page;
							endforeach; 
							?>
			...
			<div class="text-center py-16">
				<div class="max-w-md mx-auto">
					...
					<p class="text-gray-600 mb-8">
						<?php 
						printf(
							esc_html__('Kategori "%s" belum memiliki artikel. Silakan kembali ke halaman utama atau coba kategori lainnya.', 'mtq-aceh-pidie-jaya'),
