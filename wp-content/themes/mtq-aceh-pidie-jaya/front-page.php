				...
				<div class="grid lg:grid-cols-2 gap-12 items-center">
					...
					<div class="relative fade-in">
						<div class="grid grid-cols-2 gap-6">
							<div class="space-y-6">
								<img src="<?php echo get_template_directory_uri(); ?>/prototype/images/gub-wagub-aceh.png" alt="Gubernur dan Wakil Gubernur Aceh" class="w-full rounded-2xl shadow-xl" loading="lazy">
								<img src="<?php echo get_template_directory_uri(); ?>/prototype/images/logo.png" alt="Logo MTQ Aceh XXXVII" class="w-full rounded-2xl shadow-xl mx-auto max-w-[200px]" loading="lazy">
							</div>
							<div class="space-y-6 pt-12">
								<img src="<?php echo get_template_directory_uri(); ?>/prototype/images/bupati-dan-wakil-2025.png" alt="Bupati dan Wakil Bupati Pidie Jaya 2025" class="w-full rounded-2xl shadow-xl" loading="lazy">
							</div>
						</div>
					</div>
				</div>
		...
		<section id="tentang" class="py-20 relative section-animate">
			<div class="max-w-7xl mx-auto px-4">
				...
				<div class="grid lg:grid-cols-2 gap-12 items-center">
					...
					<div class="relative fade-in">
						<img src="<?php echo get_template_directory_uri(); ?>/prototype/images/hero-bg.jpg" alt="MTQ Aceh XXXVII" class="w-full rounded-2xl shadow-xl" loading="lazy">
					</div>
				</div>
			</div>
		</section>
